...
import { OnChangeSalesInput, RemoveSaleItem, SetSaleItemList } from '../../redux/state_slice/saleSlice';
...
const navigate = useNavigate();
  ...
  const ParentData = useSelector(
    (state: RootState) => state.sale.SaleFormValue,
  );
  const ChildData = useSelector((state: RootState) => state.sale.SaleItemList);
  ...
  useEffect(() => {
    ...
    const calculatedGrandTotal = subtotal + vatTax + otherCost + shippingCost - discount;
